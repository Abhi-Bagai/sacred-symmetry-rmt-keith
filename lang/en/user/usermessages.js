const userMessages = {
  ...
  meta: {
    title:
      "Sacred Symmetry Massage Therapy | Registered Massage Therapist in Chase, BC",
    description:
      "Professional registered massage therapy in Chase, BC. Book with Sacred Symmetry Massage Therapy for thoughtful, client-centered care in a calm and nourishing environment.",
    ogTitle: "Sacred Symmetry Massage Therapy | RMT in Chase, BC",
    ogDescription:
      "Professional registered massage therapy in Chase, BC. Thoughtful, evidence-informed care in a calm environment.",
  },

  // Announcement bar
  announcement: {
    text: "Now accepting bookings at Sacred Symmetry Massage Therapy.",
  },

  // Header / Navigation
  header: {
    logoAriaLabel: "Sacred Symmetry Massage Therapy - Home",
    logoText: "Sacred Symmetry Massage Therapy",
    navbarTitle: "Sacred Symmetry",
    navToggleAriaLabel: "Toggle menu",
  ...
  hero: {
    ...
    trust:
      "Personalized, evidence-informed care with a trauma-informed approach.",
    imagePlaceholder: "Image placeholder",
  },

  // About
  about: {
    heading: "About Your Therapist",
    headshotPlaceholder: "Headshot",
    paragraph1:
  ...
  benefits: {
    ...
    professionalCare: {
      ...
      description:
        "Evidence-informed treatment with a strong foundation in anatomy, physiology, and therapeutic massage.",
    },
    traumaInformed: {
      title: "Trauma-Informed Practice",
      description:
        "Treatment prioritizes safety, choice, collaboration, and consent at every stage of care.",
    },
    personalizedTreatment: {
      title: "Personalized Treatment",
      description:
        "Sessions may incorporate slow myofascial release, therapeutic massage techniques, and gentle nervous-system-focused work tailored to your needs.",
    },
    calmEnvironment: {
      title: "Calm & Nourishing Environment",
      description:
        "A respectful, inclusive, and welcoming space designed to support healing and comfort.",
    },
  },
  ...
  practiceInfo: {
    ...
    scopeOfPracticeTitle: "Scope of Practice",
    scopeOfPractice:
      "Massage Therapy in British Columbia is a regulated healthcare profession. The scope of practice for registered massage therapists includes, for the purpose of developing, maintaining, rehabilitating, or augmenting physical function, or relieving pain or promoting health: assessment of soft tissue and joints of the body, and treatment and prevention of physical dysfunction, injury, pain, and disorders of soft tissue and joints of the body by manipulation, mobilization, and other manual methods.",
    traumaInformedTitle: "Trauma-Informed Practice",
    traumaInformedIntro:
      "Trauma-informed massage therapy recognizes that many people carry stress, medical trauma, emotional wounds, or experiences of harm in their bodies and nervous systems. This approach prioritizes safety, choice, collaboration, and consent at every stage of treatment. It does not assume trauma, but it operates in a way that makes care safer for everyone.",
    traumaInformedList: [
      "Clear, ongoing consent — you are always in control of your session. You can pause, change pressure, adjust positioning, or stop at any time.",
      "Collaborative treatment planning — we discuss goals and boundaries before we begin.",
      "Predictability — I explain what I’m doing before I do it, especially in sensitive areas.",
      "Nervous system awareness — pacing, pressure, and breath are used in a way that supports regulation rather than overwhelm.",
      "Choice in positioning and draping — modifications are always available.",
      "Respect for identity and lived experience — affirming care is provided to queer, trans, and neurodivergent clients, with awareness of the layered experiences that can impact how someone feels in their body.",
    ],
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Clients are required to provide at least 24 hours' notice for any changes or cancellations to avoid a fee. If a client cancels within 24 hours of the appointment, a fee equal to 50% of the appointment cost will be charged.",
      },
      {
        question: "What if I am sick?",
        answer:
          "Please notify us as soon as possible if you are sick and stay home until you are better. No late fees apply for illness unless we have to call you for not showing up, in which case you will be charged a fee equal to 50%.",
      },
      {
        question: "Do outstanding fees affect future bookings?",
        answer:
  ...
  footer: {
    ...
    jane: "Please replace this line if booking is not handled through Jane.",
    copyright: "© {year} Sacred Symmetry Massage Therapy. All rights reserved.",
  },
};
